...
class StoreVisitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'required|in:showing,inspection,evaluation,follow_up,closing',
            'priority' => 'required|in:low,medium,high,urgent',
            'scheduled_at' => 'required|date|after:today',
            'estimated_duration' => 'integer|min:15|max:480', // 15 minutes to 8 hours
            ...
            // Reminder settings
            'reminder_hours_before' => 'integer|min:1|max:168', // 1 hour to 7 days
            
            // Completion data (for updates)
    ...
    public function messages(): array
    {
        return [
            ...
            'scheduled_at.after' => 'La fecha y hora de la visita debe ser posterior a hoy.',
