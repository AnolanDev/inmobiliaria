<template>
    <div class="relative">
        ...
        <button
            ...
            :class="[
                'w-full flex items-center gap-3 px-3 py-2.5 text-sm text-left text-gray-700 rounded-xl transition-all duration-200',
                isOpen ? 'bg-gray-50' : 'hover:bg-gray-50'
            ]"
        >
            <div class="w-8 h-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <svg 
                :class="['w-4 h-4 text-gray-500 transition-transform duration-200', isOpen ? 'rotate-180' : '']"
